...
?>
	...
	<input name="num_lot" type="HIDDEN" value="<?php echo "$num_get"; ?>">
        <table class="boiteaction">
          <caption>
          <?php echo "Editer un lot"; ?>
          </caption>
					<tr> 
            <td class="texte1"> <?php echo "produit"; ?> </td>
...
while($data = mysql_fetch_array($req))
{
  ...
  <tr> 
            ...
            <td class='<?php echo couleur_alternee (FALSE); ?>'><input name="<?php echo "lot_four_$i" ?>" type="text" size="40"value="<?php echo $tab_fourn_lot[$i]; ?>"></td>
