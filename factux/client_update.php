...
$mail_admin = $mail;
$nom=mysql_real_escape_string(isset($_POST['nom'])?$_POST['nom']:"");
$nom_sup=mysql_real_escape_string(isset($_POST['nom_sup'])?$_POST['nom_sup']:"");
$rue=mysql_real_escape_string(isset($_POST['rue'])?$_POST['rue']:"");
$ville=mysql_real_escape_string(isset($_POST['ville'])?$_POST['ville']:"");
...
$sql2 = "UPDATE " . $tblpref ."client SET fax='" . $fax . "', type='" . $type . "', tel='" . $tel . "', civ='" . $civ . "', nom='" . $nom . "', mail='" . $mail_cli . "', num_tva='" . $num_tva . "', nom2='" . $nom_sup . "', rue='" .$rue . "', ville='" . $ville . "', cp='" . $code_post . "' WHERE num_client = '" . $num . "'";
