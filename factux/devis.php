...
<table width="760" border="0" class="page" align="center">
  ...
  <tr>
	...
	$rqSql = "SELECT num, article, prix_htva, prix_htva_part, uni FROM " . $tblpref ."article WHERE actif != 'non' ORDER BY article, prix_htva, prix_htva_part";
	...
	<table class="boiteaction">
	  ...
	  <tr> 
	    ...
	    <td class="texte0"><input name='quanti' type='text' id='quanti' size='6' value='1'></td>
	  </tr>
	  <tr> 
	  ...
	  <tr> 
	    ...
	    <td class="texte0"><input name='prix_remise' type='text' id='prix_remise' size='6'></td>
	  </tr>
	  <tr> 
	    <td class="texte0"> <?php echo $lang_volume_pot; ?> </td>
	    <td class="texte0"><input name='volume_pot' type='text' id='volume_pot' size='6'></td>
	  </tr>
	  <tr> 
