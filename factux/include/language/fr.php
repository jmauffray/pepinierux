...
$lang_cré_fac_orph ="Créer une facture a partir du bon n°";
...
$lang_stock_jour="Plante mis à jour";
...
$lang_art_effa= " Etes-vous sur de vouloir effacer la plante ";
$lang_lot_inact= " Etes-vous sur de vouloir désactiver le lot n° ";
$lang_cli_effa = " Etes-vous sur de vouloir effacer le client ";
...
$lang_mdp_chang = "Votre mot de passe a été changé <br>Un mail vas etre envoyé avec vos nouveau login et mot de passe !";
...
$lang_notif_env = "Notification de changement du mot de passe envoyé !";
...
$lang_cli_jour = "Le client a été mis à jour";
...
$lang_er_mo_pa = "Erreur le login existe déja";
$lang_mot_pa = "Erreur les deux mots de passe ne correspondent pas";
$lang_dev_cov = "Le devis $num_dev a bien été converti en bon de commande $max ";
...
$lang_back_resto = "Votre restauration de backup a été effectuée sans problemes ";
...
$lang_back_lon2 = "Ce fichier ne peut ętre restauré que grâce a l'utilitaire de backup de Factux et la base de donnée doit avoir le meme nom <br> N'oubliez pas d'effacer ce backup apres l'avoir téléchargé. Laisser un backup sur le serveur est un risque potentiel pour la sécurité de factux.";
...
$lang_dep_enr ="La depense a été enregitrée";
$lang_rappel = "Selectionnez les factures a inclure au rappel";
$lang_erreur_var = " Je peux ecrire dans le fichier include/config/var.php . Veuillez réduire les droits de ce fichier a la lecture simple.";
$lang_erreur_common = "Je peux ecrire dans le fichier include/config/common.php . Veuillez réduire les droits de ce fichier a la lecture simple.<br>";
...
$lang_interdit = "Vous n\'ętes pas autorisé a accéder cette zone";
$lang_devis = "Devis";
...
$lang_authentification_ko = "Vous n'ętes pas autorisé a accéder cette zone";
...
$lang_client_accesprive = "Optionnel (pour permettre l'accès a la partie client)<br>
...
$lang_nouv_art = "Votre nouvel plante a bien été ajouté dans le catalogue.";
...
$lang_quanti = "Q";
$lang_remise = "Remise(%)";
$lang_prix_remise = "Prix après remise";
...
$lang_tri = "Trier par";
$lang_date = "Date";
$lang_client_enr = "Votre nouveau client $nom a bien été enregistré.";
...
$lang_bon_effa = "Le bon $num_bon a été effacé.";
...
$lang_err_fact = "Certains bons de commande appartiennent déja a une facture.";
...
$lang_art_jour = "Prix de la plante mis a jour";
