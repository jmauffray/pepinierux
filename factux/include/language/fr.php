...
$lang_choix_theme ="Choisir le thęme de Factux";
...
$lang_use_cat ="Utiliser le module des origines";
$lang_modif_par ="Modifier les paramčtres de Factux";
$lang_cr_lot ="Créer un lot.";
$lang_depenses_par_fournisseur ="Statistiques par fournisseur ";
$lang_conf_env = " Etes-vous sűr de vouloir envoyer la facture n°";
$lang_conf_env2= "par mail au client";
$lang_conf_notif =" Etes-vous sűr de vouloir notifier le client";
$lang_conf_notif2 ="de l\'existence de la facture ";
$lang_par ="par";
$lang_conf_carte_reg =" Etes-vous sűr de vouloir régler la facture n° ";
$lang_con_env_pdf=" Etes-vous sűr de vouloir envoyer par mail le bon n°";
$lang_con_env_notif=" Etes-vous sűr de vouloir notifier par mail le client du bon n°";
...
$lang_cré_fac_orph ="Créer une facture ŕ partir du bon n°";
$lang_num_dev ="Devis n° ";
$lang_tele = "Téléphone";
$lang_fax = "Fax";
$lang_civ = "Civilité";
$lang_nouv_categorie = "Nouvelle origine ajoutée";
$lang_cat_nom ="nom de la origine";
$lang_categorie_ajout= "Ajouter une origine";
$lang_categorie = "Origine";
$lang_taille = "Taille";
$lang_variete = "Variété";
$lang_conditionnement = "Conditionnement";
...
$lang_stock_jour="Plante mis ŕ jour";
...
$lang_regler_fact = " Etes-vous sűr de vouloir mettre la facture n° ";
$lang_art_effa= " Etes-vous sűr de vouloir effacer la plante ";
$lang_lot_inact= " Etes-vous sűr de vouloir désactiver le lot n° ";
$lang_cli_effa = " Etes-vous sűr de vouloir effacer le client ";
$lang_eff_dev = " Etes-vous sűr de vouloir effacer le devis n°";
$lang_convert_dev = " Etes-vous sűr de vouloir transformer le devis n°";
$lang_convert_dev2 = "en bon de commande ?";
$lang_dev_perd = " Etes-vous sűr de vouloir mettre le devis n°";
$lang_dev_perd2 ="au statut perdu ?";
$lang_eff_conf_dep = "Etes-vous sűr de vouloir effacer la dépense n°";
////
...
$lang_ger_art = "Peut gerer les plantes ?";
...
$lang_article_droit = "Vous n'avez pas les droits necessaires pour gerer les plantes contacter l'administrateur si vous penser qu'il y as erreur";
...
$lang_mdp_chang = "Votre mot de passe ŕ été changé <br>Un mail vas etre envoyé avec vos nouveau login et mot de passe ŕ";
...
$lang_notif_env = "Notification de changement du mot de passe envoyé ŕ";
...
$lang_avoir_num_ab = "AVOIR N°";
$lang_totaux = "Total HT: \n Total TVA: \n Total TTC:";
$lang_num_bon_ab = "BON DE LIVRAISON";
$lang_de = "de";
$lang_page = "Page";
$lang_condi = "Facturation ŕ suivre fin de mois\n De faktuur zal op het einde van de maand toe gestuurd worden\n";
$lang_prix_htva = "Prix HT";
$lang_dev_pdf_soc = "Société\nSičge social/Sociaal zetel\n Tel/Fax\n TVA/B.T.W\n Banque/Bank\n email";
...
$lang_t_tva = "TVA";
$lang_con_per = "Etes-vous sűr de vouloir mettre ce devis au statut perdu ?";
$lang_con_gag = "Etes-vous sűr de vouloir mettre ce devis au statut gagné ?";
$lang_con_effa_dev = "Etes-vous sűr de vouloir effacer ce devis ?";
$lang_mail_a = "mail envoyé ŕ:";
$lang_benef = "Bénéfice";
...
$lang_cli_jour = "Le client ŕ été mis ŕ jour";
...
$lang_er_mo_pa = "Erreur le login existe déjŕ";
$lang_mot_pa = "Erreur les deux mots de passe ne correspondent pas";
$lang_dev_cov = "Le devis $num_dev ŕ bien été converti en bon de commande $max ";
...
$lang_back_resto = "Votre restauration de backup ŕ été effectuée sans problemes ";
$lang_back_ext = "Fichier backup.sql extrait de $file. ";
$lang_back_ti_re = "Utilitaire de backup de Factux: Restaurer un backup";
$lang_back_ret = "Retour ŕ l'utilitaire de backup";
$lang_back_lon2 = "Ce fichier ne peut ętre restauré que grâce ŕ l'utilitaire de backup de Factux et la base de donnée doit avoir le meme nom <br> N'oubliez pas d'effacer ce backup apres l'avoir téléchargé. Laisser un backup sur le serveur est un risque potentiel pour la sécurité de factux.";
...
$lang_dep_enr ="La depense ŕ été enregitrée";
$lang_rappel = "Selectionnez les factures ŕ inclure au rappel";
$lang_erreur_var = " Je peux ecrire dans le fichier include/config/var.php . Veuillez réduire les droits de ce fichier ŕ la lecture simple.";
$lang_erreur_common = "Je peux ecrire dans le fichier include/config/common.php . Veuillez réduire les droits de ce fichier ŕ la lecture simple.<br>";
...
$lang_prixunitaire = "Tarif HT";
$lang_reglement_conditions = "Conditions de rčglement: Rčglement 30 jours aprčs livraison";
$lang_interdit = "Vous n\'ętes pas autorisé ŕ accéder cette zone";
$lang_devis = "Devis";
...
$lang_articles_liste = "Liste des Plantes";
$lang_article_creer = "Créer un plante";
...
$lang_authentification_ko = "Vous n'ętes pas autorisé ŕ accéder cette zone";
...
$lang_client_accesprive = "Optionnel (pour permettre l'accčs ŕ la partie client)<br>
...
$lang_articles_existants = "Les plantes existants";
...
$lang_nouv_art = "Votre nouvel plante ŕ bien été ajouté dans le catalogue.";
...
$lang_quanti = "Q";
$lang_remise = "Remise(%)";
$lang_prix_remise = "Prix aprčs remise";
$lang_volume_pot = "Volume Pot (Litres)";
$lang_article = "Plante";
$lang_valid = "Valider";
...
$lang_tri = "Trier par";
$lang_date = "Date";
$lang_client_enr = "Votre nouveau client $nom ŕ bien été enregistré.";
$lang_effacer_bon = "Etes-vous sűr de vouloir effacer le bon de commande $num_bon de $nom ?";
$lang_effacer = "Effacer";
$lang_client = "Client";
$lang_rech = "Rechercher";
$lang_client_ajouter = "Ajouter un client";
$lang_bon_effa = "Le bon $num_bon ŕ été effacé.";
$lang_li_effa = "La ligne ŕ été effacée.";
...
$lang_err_fact = "Certains bons de commande appartiennent déjŕ ŕ une facture.";
