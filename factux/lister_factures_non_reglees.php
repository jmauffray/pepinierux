...
$sql = "SELECT TO_DAYS(NOW()) - TO_DAYS(date_fact) AS peri, client,r1, r2, r3,  date_deb, date_fin,
               total_fact_ttc, num, nom, nom2, date_echeance, DATE_FORMAT(date_fact,'%d/%m/%Y') AS date_fact
...
?>
  ...
  <caption><?php echo $lang_factures_non_reglees; ?></caption>
        <tr> 
          ...
          <th><a href="lister_factures_non_reglees.php?ordre=peri">Avant echeance</a></th>
...
//     echo "***d2=" . $dateE;
//     echo $deadline2;
//     echo "//" . date(DATE_ATOM,$deadline2);
//     echo "d1=" . $date;
//     echo $deadline1;
//     echo "//" . date(DATE_ATOM,$deadline1);
    ...
    $peri = round( ($deadline2 - $deadline1) / (60 * 60 * 24) ) + 1;
 ...
 ?>
        <tr class="texte<?php echo"$line" ?>" onmouseover="this.className='highlight'" onmouseout="this.className='texte<?php echo"$line" ?>'">
          ...
          <td class="highlight"><?php echo montant_financier($total); ?></td>
									    <td class="highlight" <?php if($peri<0) {echo "bgcolor=\"Coral\"";}echo $num_client; ?>><a href='rapel.php?client=<?php echo $num_client; ?>'><?php echo "$peri $lang_jours"; ?></a></td>
          <td class="highlight">
	<?php
	if($use_payement =='y'){ ?>				
  ...
  <option value="cheque"><?php echo"$lang_cheque"; ?></option>
