...
<input name='article' type='text' id='article' size='8' value='<?php echo $num_art; ?>'>
<?php } ?>
</td></tr>
    <tr> 
    ...
    <tr> 
      <td  class="texte0" > <?php echo $lang_prix_remise ?> 
          </td><td class="texte0"><input name="prix_remise" type="text" size="5" id="prix_remise" value='<?php echo $prix_remise; ?>' >
      </td> 
    </tr>
    <tr> 
      <td  class="texte0" > <?php echo $lang_volume_pot ?> 
          </td><td class="texte0"><input name="volume_pot" type="text" size="5" id="volume_pot" value='<?php echo $volume_pot; ?>' >
      </td> 
    </tr>
    <tr>
