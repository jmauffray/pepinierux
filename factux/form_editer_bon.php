...
<FORM action="chang_cli.php" method="POST" name="formu">
  <table class="boiteaction">
	...
	<tr> 
	  ...
	  <td class='<?php echo couleur_alternee (FALSE); ?>'><?php echo  $remise; ?></td>
	  <td class='<?php echo couleur_alternee (FALSE); ?>'><?php echo  $volume_pot; ?></td>
	  ...
	  <?php echo "<a href=delete_cont_bon.php?num_cont=$num_cont&amp;num_bon=$num_bon&amp;type=$type onClick='return confirmDelete()'><img border=0 src= image/delete.jpg ></a>" ?>
	</td> </tr>
	<?php
	...
	<table class="boiteaction">
	  ...
	  <tr> 
		...
		</td><td class="texte0" colspan="8"><input name="prix_remise" type="text" id="prix_remise" size="6">
	      </td></tr>
	      <tr> 
		<td class="texte0"><?php echo $lang_volume_pot; ?> 
		</td><td class="texte0" colspan="8"><input name="volume_pot" type="text" id="volume_pot" size="6">
	      </td></tr>
	      <tr> 
