...
?>
  <tr>
	...
	<tr>
     ...
     <td colspan="3" class="texte0"><input name="prix_remise" type="text" size="5" id="prix_remise" value='<?php echo"$prix_remise"?>' >
	<tr>
     <tr>
     <td class="texte0"><?php echo $lang_volume_pot ?>
     <td colspan="3" class="texte0"><input name="volume_pot" type="text" size="5" id="volume_pot" value='<?php echo"$volume_pot"?>' >
	<tr>
...
echo "<td class='texte0'>";
 echo "<input name='article' type='text' id='article' size='8' value=".$article_num.">";
