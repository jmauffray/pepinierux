...
$num = $data['client_num'];
$coment = $data['coment'];
$sql = "SELECT " . $tblpref ."cont_dev.num, quanti, remise, volume_pot, uni, article, article_num, tot_art_htva, to_tva_art tva
...
$total_tva += $tva;
  ...
  ?>
  <tr>
  <td class='<?php echo couleur_alternee (FALSE); ?>'><?php echo $ligne; ?></td>
  <td class='<?php echo couleur_alternee (FALSE); ?>'><?php echo  $article_num; ?></td>
  <td class='<?php echo couleur_alternee (TRUE,"nombre"); ?>'><?php echo $quanti; ?></td>
  <td class='<?php echo couleur_alternee (FALSE); ?>'><?php echo  $remise; ?>
  </td>
  <td class='<?php echo couleur_alternee (FALSE); ?>'><?php echo  $volume_pot; ?>
  </td>
...
<tr> 
        ...
        </td><td class="texte0" colspan="6"><input name="quanti" type="text" id="quanti" size="6" value="1">
        </td class="texte0"></tr>
        <tr> 
          <td class="texte0"><?php echo $lang_remise; ?> 
        </td><td class="texte0" colspan="6"><input name="remise" type="text" id="remise" size="6">
        </td class="texte0"></tr>
        <tr> 
          <td class="texte0"><?php echo $lang_prix_remise; ?> 
        </td><td class="texte0" colspan="6"><input name="prix_remise" type="text" id="prix_remise" size="6">
        </td class="texte0"></tr>
        <tr> 
          <td class="texte0"><?php echo $lang_volume_pot; ?> 
        </td><td class="texte0" colspan="6"><input name="volume_pot" type="text" id="volume_pot" size="6">
        </td class="texte0"></tr>
        <tr> 
